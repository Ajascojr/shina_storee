...
if (isset($_POST['cart_btn'])) {
    ...
    // Assuming you have a quantity variable (for example, $quantity)
    ...
    $qr = "INSERT INTO cart_tb(product_id, user_id, product_price, quantity, total_price) VALUES ('$product_id', '$user_id', '$product_price', '$quantity', '$total_price')";
...
<div class="container mt-5">
    <div class="row">
        ...
        <form action="" method="POST">
            ...
            <button class="btn btn-primary" name ="cart_btn" ><i class="fa-solid fa-cart-plus"></i>   Add to Cart</button>
        </form>
